\section{Drinfeld Yangians}
    ...
    We shall refer to $\calY_{\hbar}(\g)$ as the \textbf{formal Drinfeld Yangian} in order to distinguish it from its \say{special fibre} at any $\hbar_0 \in \bbC^{\x}$ (and we might as well set $\hbar_0 := 1$):
        $$\calY(\g) := \calY_{\hbar}(\g)/(\hbar - \hbar_0)\calY_{\hbar}(\g)$$
    which shall be known to us as \say{the} \textbf{Drinfeld Yangian}. The former shall turn out to be the Rees algebra of the latter, with respect to a natural $\Z_{\geq 0}$-grading thereon. Furthermore, it will turn out to be the case that:
    ...
    \subsection{Drinfeld Yangians as PBW deformations}
        ...
        \end{convention}
        \begin{definition}[Formal Drinfeld Yangians] \label{def: formal_drinfeld_yangians}
        ...
        \end{definition}
        \begin{definition}[Drinfeld Yangians] \label{def: drinfeld_yangians}
            The \textbf{Drinfeld Yangian} of $\g$, denoted by $\calY(\g)$, is given by:
                $$\calY(\g) := \calY_{\hbar}(\g)/\calY_{\hbar}(\g) \cdot (\hbar - 1)$$
        \end{definition}
        \begin{remark}[The degree grading/filtration on $\calY_{\hbar}(\g)$ and $\calY(\g)$] \label{remark: the_degree_grading_on_drinfeld_yangians}
        ...
        \end{convention}
        \begin{theorem}[PBW bases for formal Drinfeld Yangians] \label{theorem: PBW_bases_for_formal_yangians}
        ...
        \end{theorem}
        \begin{corollary}[Formal Drinfeld Yangians as graded deformations] \label{coro: formal_yangians_as_graded_deformations}
        ...
        \begin{lemma}[Finite-type Drinfeld Yangians as PBW deformations] \label{lemma: drinfeld_yangians_as_PBW_deformations}
        ...
        \end{lemma}
            ...
            \end{proof}
        \begin{corollary}[Centres of Drinfeld Yangians] \label{coro: centres_of_drinfeld_yangians}
        ...
        \begin{theorem}[PBW bases for Drinfeld Yangians] \label{theorem: PBW_bases_for_drinfeld_yangians}
        ...
        \end{theorem}
        \begin{corollary}[Triangular decompositions of Drinfeld Yangians] \label{coro: triangular_decompositions_of_drinfeld_yangians}
            Fix a total ordering on the set:
                $$\Sigma := \{X_{\alpha, r}^{\pm}\}_{(\alpha, r) \in \Phi^+ \x \Z_{\geq 0}} \cup \{H_{i, r}\}_{(i, r) \in \simpleroots \x \Z_{\geq 0}}$$
    ...
    \subsection{Drinfeld Yangians as quantisations}
        ...
        \begin{proposition}[The Drinfeld Yangian Manin triple] \label{prop: the_yangian_manin_triple}
        ...
        \begin{theorem}[Drinfeld Yangian Hopf structure] \label{theorem: yangian_hopf_structure}
        ...
        \end{theorem}
        \begin{corollary}[Drinfeld Yangians as quantisations] \label{coro: yangians_as_quantisations}
        ...
        \begin{proposition}[Drinfeld Yangian Hopf structure in terms of Levendorskii's presentation] \label{prop: yangian_hopf_structure_via_levendorskii_presentation}
        ...
        \begin{proposition}[The shift automorphisms] \label{prop: drinfeld_yangians_shift_automorphisms}
        ...
        One can also package the Drinfeld Yangian generators $X_{i, r}^{\pm}, H_{i, r}$ from definition \ref{def: formal_drinfeld_yangians} into \textbf{generating  series}:
        ...
        \begin{proposition}[Generating series for formal Drinfeld Yangians] \label{prop: generating_series_for_finite_untwisted_yangians}
    ...
    \subsection{The RTT presentation for Drinfeld Yangians} \label{subsection: RTT_presentation_for_drinfeld_yangians}
        ...
        Fix also an auxiliary $\g_N$-module $V$.
