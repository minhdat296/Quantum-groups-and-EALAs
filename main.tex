...
\begin{document}
    ...
    \part{Representations of quivers and quiver varieties}
        \chapter{Associative algebras of low homological dimensions}
            ...
            \input{Chapters/Quivers/semi-simple algebras}
            
            \input{Chapters/Quivers/dynkin quivers}
            
            \input{Chapters/Quivers/derived categories of coherent sheaves and quivers}
            
        \chapter{Quiver varieties and Kac-Moody algebras}
            \begin{abstract}
            ...
            \input{Chapters/Quiver varieties and Kac-Moody algebras/nakajima quiver varieties}
            
            \input{Chapters/Quiver varieties and Kac-Moody algebras/mckay correspondence}
            
            \input{Chapters/Quiver varieties and Kac-Moody algebras/kac-moody algebras}
        ...
        \begin{appendices}
            \chapter{Reductive groups}
                ...
                \input{Chapters/Appendices/Reductive groups/algebraic groups}
            
                \input{Chapters/Appendices/Reductive groups/normalisers and centralisers}
                
                \input{Chapters/Appendices/Reductive groups/reductive groups}
                
                \input{Chapters/Appendices/Reductive groups/roots and coroots}
                
                \input{Chapters/Appendices/Reductive groups/split reductive groups}
        \end{appendices}
