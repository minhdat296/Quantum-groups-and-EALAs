    ...
    \subsection{Algebras}
        ...
        \begin{question}
            \begin{enumerate}
                ...
                \begin{itemize}
                    \item \textbf{(Left-associativity):} \todo[inline]{Associativity of module actions}
                    \item \textbf{(Left and right-unitality):} \todo[inline]{Unitality of module actions}
                \end{itemize}
        ...
        \begin{definition}[Algebras] \label{def: algebras}
            \todo[inline]{Algebras in monoidal categories}
        \end{definition}
