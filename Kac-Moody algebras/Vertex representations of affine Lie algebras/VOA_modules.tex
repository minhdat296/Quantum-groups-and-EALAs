\section{Modules over VOAs and examples}
    ...
    \subsection{Heisenberg algebras, rank-1 lattice VOAs, and the boson-fermion correspondence}
       ...
       In any event, the underlying vector space of $\V_L^{\lambda}$ is then acted on by $\tilde{\scrH}_L$ (from the left!) in the following manner: 
        ...
        \end{proposition}
            ...
            \begin{remark}[Bosonic strings and bosonic vertex operators]
            ...
            \begin{proposition}[(Super) VOA structures on Weyl vacuum modules] \label{prop: (super)_VOA_structures_on_weyl_vacuum_modules}
            ...
            \begin{convention}[The full rank-$1$ bosonic Fock space]
            ...
            \todo[inline]{Fermions are described by super VOAs because of the Pauli Exclusion Principle, which postulates that half-integer spins, i.e. fermions, must be coupled.}
    ...
    \subsection{General lattice VOAs and the Frenkel-Kac vertex realisation of basic representations of affine Lie algebras}
        ...
        \end{definition}
        A standard argument shows that as a left-$\tilde{\scrU}_{\kappa}$-module, the vacuum module $\V_{\kappa}$ is identified with $\tilde{\scrU}_{\kappa}^-$. Using PBW, one can also explicitly compute the underlying vector space of $\tilde{\scrU}_{\kappa}^-$ to be spanned by ordered monomials of the form
        ...
        \begin{theorem}[The Frenkel-Kac realisation of $\simple^1(\hat{\sl}_2)$]
        ...
        \begin{theorem}[The Frenkel-Kac realisation of $\simple^{\varpi_1}(\hat{\g})$]
