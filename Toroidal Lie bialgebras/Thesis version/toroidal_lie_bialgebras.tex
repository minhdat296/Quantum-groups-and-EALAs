\section{Affine Yangians as quantisations}
    ...
    \subsection{Manin triples and quantisations of Lie bialgebras} \label{subsection: manin_triples_and_quantisations_of_lie_bialgebras}
        ...
        \end{remark}
        The construction of (graded) Drinfeld doubles leads to the following definition:
        ...
        \begin{lemma}[Lie bialgebras from Manin triples] \label{lemma: lie_bialgebras_from_manin_triples}
            \begin{enumerate}
                \item There is a bijective function from the set of finite-dimensional Lie bialgebras to the set of finite-dimensional Manin triples, which maps a given Lie bialgebra $(\a, [-, -], \delta)$ to the Manin triple $(\frakDr(\a), \a, \a^*)$, with the underlying vector space of $\frakDr(\a)$ being $\a \oplus \a^*$.
                \item Let $Z$ be an abelian group. 

                There is a bijective function from the set of $Z$-graded Lie bialgebras with finite-dimensional graded components to the set of $Z$-graded Manin triples $(\p, \p^+, \p^-)$ where each of $\p, \p^+, \p^-$ has finite-dimensional graded components, which maps such a $Z$-graded Lie bialgebra $(\a, [-, -], \delta)$ to the Manin triple $(\frakDr(\a), \a, \a^*)$, with the underlying vector space of $\frakDr(\a)$ being $\a \oplus \a^{\star}$.
            \end{enumerate}
        \end{lemma}
