\section{Construction Yangian extended toroidal Lie algebras}
    \subsection{Extending \texorpdfstring{$\toroidal$}{} by derivations to fix degeneracy}
        ...
        \begin{proposition}[$\toroidal$ as a $\der_k(A)$-module] \label{prop: toroidal_lie_algebras_as_modules_over_vector_field_lie_algebras}
            $\toroidal$ is a $\der_k(A)$-module, decomposing into a direct sum of the submodules $\g_{[2]}$ and $\z_{[2]}$. 
        \end{proposition}
    ...
    \subsection{Non-uniqueness of Yangian extended toroidal Lie brackets}
        ...
        \begin{remark}[Some explicit elements of $H^2_{\Lie}(\d_{[2]}, \z_{[2]})$] \label{remark: non_uniqueness_of_yangian_extended_lie_algebras}
            ...
            contains at least $2$-cocyles that we shall denote by:
                $$\sigma_1, \sigma_2$$
            These \say{twist} the Lie brackets (in the sense of proposition \ref{prop: lie_brackets_on_extensions}):
