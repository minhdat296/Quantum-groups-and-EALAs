\section{A root grading for Yangian extended toroidal Lie algebra} \label{section: root_grading_for_yangian_EALAs}
    ...
    \subsection{Positive/negative Yangian extended toroidal Lie algebras}
        Now, even though the \say{full} (Yangian extended) toroidal Lie algebras $\toroidal$ and $\extendedtoroidal$ are interesting in their own rights, they are somehow more related to the \say{Yangian double} associated to $\hat{\g}$ (cf. \cite[Subsection 2.3 and Section 6]{wendlandt_formal_shift_operators_on_yangian_doubles}), whereas our interest is towards the \say{Yangian} of $\hat{\g}$ (cf. section \ref{section: yangians_of_kac_moody_algebras}), which necessitates us concerning ourselves with certain Lie subalgebras of $\toroidal$ and $\extendedtoroidal$, to be thought of as the \say{positive half} with respect to the variable $t$ of these Lie algebras. 
        ...
        \begin{remark}[Why must we work only with $\extendedtoroidal := \toroidal \rtimes \d_{[2]}$ ?] \label{remark: why_yangian_toroidal_semi_direct_product}
    ...
    \subsection{Root grading and triangular decomposition for Yangian extended toroidal Lie algebras}
        ...
        \end{proposition}
        \begin{remark}[Toroidal Virasoro algebras] \label{remark: toroidal_virasoro_algebras}
            ...
            \todo[inline]{I think this should help us understand the classical R-matrix of $\toroidal^{\positive}$ somehow, but I have not been able to express this idea precisely yet.}
        \end{remark}