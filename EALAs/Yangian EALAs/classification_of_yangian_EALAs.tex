\section{Classification of Yangian extended toroidal Lie algebras}
    ...
    \subsection{Which extended toroidal Lie algebras are Yangian ?}
        ...
        Now that we have a criterion for a given toroidal $2$-cocycle to be Yangian, let us apply it to some known toroidal $2$-cocycles from \cite{billig_energy_momentum_tensor} to check whether or not they are Yangian. Namely, let us give an example and a counter-example of Yangian toroidal $2$-cocycles.
        \begin{example} \label{example: yangian_cocycles_(counter)_examples}
            ...
            \todo[inline]{I think I have managed to show that $\sigma_1$ is invariant while $\sigma_2$ is not. There were some misplaced brackets and sign errors before.}
            \begin{itemize}
                \item 
                    $$
                        \begin{aligned}
                ...
                \item
                    $$
                        ...
                        \end{aligned}
                    $$
                \todo[inline]{Write this out in terms of basis elements of $\z_{[2]}$.}
                \item
                    $$
                        \begin{aligned}
                            & \sigma_p(D_v, D_t)
            ...
            \todo[inline]{Write out the entries of the matrices $\bfA(\sigma_p)$ and $\bfB(\sigma_p)$.}
        \end{example}