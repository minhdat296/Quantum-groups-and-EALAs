\section{Construction of \texorpdfstring{$\gamma$}{}-extended toroidal Lie algebras}
    \subsection{Outline and statement of the main result}
        ...
        \begin{proposition}[A non-degenerate bilinear form extending $(-, -)_{\toroidal}$]
    ...
    \subsection{Which twisted semi-direct products are \texorpdfstring{$\gamma$}{}-extended toroidal Lie algebras ?}
        \todo[inline]{Proof of the "if" direction of the main theorem.}
        ...
        \end{lemma}
            ...
            \end{lemma}
        \begin{theorem}[An $\gamma$-invariance criterion for toroidal $2$-cocycles] \label{theorem: yangian_criterion_for_toroidal_cocycles}
