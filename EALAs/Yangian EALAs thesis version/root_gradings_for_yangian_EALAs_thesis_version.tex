\section{A root grading for \texorpdfstring{$\gamma$}{}-extended toroidal Lie algebra} \label{section: root_grading_for_yangian_EALAs}
    ...
    \subsection{Positive/negative \texorpdfstring{$\gamma$}{}-extended toroidal Lie algebras}
        ...
        \begin{lemma}[Positive/negative $\gamma$-extended toroidal Lie algebras] \label{lemma: positive/negative_yangian_extended_toroidal_lie_algebras}
    ...
    \subsection{Root grading and triangular decomposition for \texorpdfstring{$\gamma$}{}-extended toroidal Lie algebras}
        ...
        \begin{theorem}[Root grading for $\gamma$-extended toroidal Lie algebras] \label{theorem: root_grading_for_extended_toroidal_lie_algebras}
        ...
        \begin{proposition}[Triangular decomposition for $\gamma$-extended toroidal Lie algebras] \label{prop: triangular_decomposition_of_extended_toroidal_lie_algebras}
