...
\begin{document}
    ...
    \input{Notes/Toroidal Lie bialgebras/extended_toroidal_lie_algebras}

    \input{Notes/Toroidal Lie bialgebras/classical_limits_of_yangians}

    \input{Notes/Toroidal Lie bialgebras/R_matrices_of_affine_yangians_and_toroidal_lie_bialgebras}
