...
\begin{document}
    ...
    \section{Constructing Lie cobrackets on (extended) toroidal Lie algebras}
        ...
        \subsection{Extending \texorpdfstring{$\tilde{\g}_{[2]}$}{} to fix degeneracy}
                        ...
                        from which one infers that:
                            $$
                                \begin{aligned}
                                    ...
                                    = & -\sum_{r \in \Z \setminus \{0\}} h v_1^{-r} \tensor v_2^r t_2^{-1} \bar{d}(t_2)
                                    \\
                                    = & -(h \tensor \bar{d}(t_2)) \left( \sum_{r \in \Z \setminus \{0\}} v_1^{-r} v_2^r \right) t_2^{-1}
                                \end{aligned}
                            $$
                        whenever $r \in \Z \setminus \{0\}$; in particular, this implies that:
                            $$
                                \begin{aligned}
                                    & -\sum_{r \in \Z} r h v_1^{-r} \tensor K_{r, 0} + h \tensor c_{t_2}
                                    \\
                                    = & (h \tensor \bar{d}(t_2)) \left( \sum_{r \in \Z \setminus \{0\}} v_1^{-r} v_2^r \right) t_2^{-1} + (h \tensor \bar{d}(t_2)) t_2^{-1}
                                    \\
                                    = & (h \tensor \bar{d}(t_2)) \left( \sum_{r \in \Z} v_1^{-r} v_2^r \right) t_2^{-1}
                                \end{aligned}
                            $$
                        ...
                        and then consider the following:
                            $$
                                \begin{aligned}
                                    ...
                                    \\
                                    = & \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( -\frac1r v_1^r t_1^{s - 1} \bar{d}(t_1) \tensor r h v_2^{-r} t_2^{-s} - r h v_1^{-r} t_1^s \tensor \left(-\frac1r v_2^r t_2^{-s - 1} \bar{d}(t_2)\right) \right)
                                    \\
                                    = & \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( -v_1^r t_1^{s - 1} \bar{d}(t_1) \tensor h v_2^{-r} t_2^{-s} + h v_1^{-r} t_1^s \tensor v_2^r t_2^{-s - 1} \bar{d}(t_2) \right)
                                    \\
                                    = & ( \bar{d}(t_1) \tensor h + h \tensor \bar{d}(t_2) ) \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( -v_1^r t_1^{s - 1} \tensor v_2^{-r} t_2^{-s} + v_1^{-r} t_1^s \tensor v_2^r t_2^{-s - 1} \right)
                                \end{aligned}
                            $$
                        ...
                        We now have that:
                            $$
                                \begin{aligned}
                                    & [\bar{\Delta}(ht), \sfr_{\z_{[2]}^+} + \sfr_{\d_{[2]}^+}]
                                    \\
                                    = & ( \bar{d}(t_1) \tensor h + h \tensor \bar{d}(t_2) ) \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( -v_1^r t_1^{s - 1} \tensor v_2^{-r} t_2^{-s} + v_1^{-r} t_1^s \tensor v_2^r t_2^{-s - 1} \right) + (h \tensor \bar{d}(t_2)) \left( \sum_{r \in \Z} v_1^{-r} v_2^r \right) t_2^{-1}
                                    \\
                                    = & ( \bar{d}(t_1) \tensor h + h \tensor \bar{d}(t_2) ) \sum_{(r, s) \in \Z \x \Z_{\geq 0}} \left( -v_1^r t_1^{s - 1} \tensor v_2^{-r} t_2^{-s} + v_1^{-r} t_1^s \tensor v_2^r t_2^{-s - 1} \right)
                                    \\
                                    = & \left( \bar{d}(t_1) \tensor h + h \tensor \bar{d}(t_2) \right) v_2 \1(v_1, v_2) \1^+(t_1, t_2)
                                \end{aligned}
                            $$
