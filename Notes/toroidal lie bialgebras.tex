                        ...
                        From this, we see that it suffices to make the following computations:
                            ...
                            $$
                                \begin{aligned}
                                    ...
                                    \\
                                    & = x v^m t^p \tensor ( [y, x^*] v^{a - m} t^{b - p - 1} - (y, x^*)_{\g} v^a t^b \bar{d}(v^{-m} t^{-p - 1}) )
                                    \\
                                    & = ( x \tensor [y, x^*] ) v^a t^{b - 1} - (y, x^*)_{\g} v^{m + a} t^{p + b} ( x \tensor \bar{d}(v^{-m} t^{-p - 1}) ) 
                                \end{aligned}
                            $$
                        which then yields:
                            $$
                                \begin{aligned}
                                    ...
                                    \right)
                                    \\
                                    = & \sum_{(m, p) \in \Z^2} \left( ( [y, x] \tensor x^* + x \tensor [y, x^*] ) v^a t^{b - 1} - \left(
                                    \begin{aligned}
                                        & (y, x)_{\g} v^{a - m} t^{b - p - 1} ( \bar{d}(v^m t^p) \tensor x^* )
                                        \\
                                        + & (y, x^*)_{\g} v^{m + a} t^{p + b} ( x \tensor \bar{d}(v^{-m} t^{-p - 1}) )
                                    \end{aligned}
                                    \right) \right)
                                \end{aligned}
                            $$
