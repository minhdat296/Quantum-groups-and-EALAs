                ...
                \begin{enumerate}
                    ...
                    \begin{enumerate}
                        ...
                        Again, we consider firstly the following:
                            $$
                                \begin{aligned}
                                    ...
                                    \\
                                    & = \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( [Y_1, Z_{r, s}] \tensor D_{r, s} + [Y_1, c_{v_1}] \tensor D_{v_2} \right)
                                \end{aligned}
                            $$
                        ...
                        In contrast, the term $[1 \tensor Y_2, \sfr_{\z_{[2]}^+}]$ does not necessarily vanish. To see why, consider the following:
                            $$
                                \begin{aligned}
                                    ...
                                    \\
                                    & = \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( Z_{r, s} \tensor [Y_2, D_{r, s}] + c_{v_1} \tensor [Y_2, D_{v_2}] \right)
                                    \\
                                    & = \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( Z_{r, s} \tensor y_2 D_{r, s}(v_2^a t_2^b) + c_{v_1} \tensor y_2 D_{v_2}(v_2^a t_2^b) \right)
                                \end{aligned}
                            $$

                        We thus gather that:
                            $$[Y_1 \tensor 1 + 1 \tensor Y_2, \sfr_{\z_{[2]}^+}] = \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( Z_{r, s} \tensor y_2 D_{r, s}(v_2^a t_2^b) + c_{v_1} \tensor y_2 D_{v_2}(v_2^a t_2^b) \right)$$
                        ...
                        \item Similarly to the previous case, we can calculate:
                            $$[Y_1 \tensor 1 + 1 \tensor Y_2, \sfr_{\bar{\d}_{[2]}^+}] = \sum_{(r, s) \in \Z \x \Z_{> 0}} \left( y_1 D_{r, s}(v_1^a t_1^b) \tensor Z_{r, s} + y_1 D_{v_1}(v_1^a t_1^b) \tensor c_{v_2} \right)$$
                    \end{enumerate}
                    Addint the three summands together yields:
                        $$
                            \begin{aligned}
                                ...
                                \begin{aligned}
                                    ...
                                    \right)
                                    \\
                                    + & \sum_{(r, s) \in \Z \x \Z_{> 0}} \left(
                                    \begin{aligned}
                                        & \left( Z_{r, s} \tensor y_2 D_{r, s}(v_2^a t_2^b) + c_{v_1} \tensor y_2 D_{v_2}(v_2^a t_2^b) \right)
                                        \\
                                        + & \left( y_1 D_{r, s}(v_1^a t_1^b) \tensor Z_{r, s} + y_1 D_{v_1}(v_1^a t_1^b) \tensor c_{v_2} \right)
                                    \end{aligned}
                                    \right)
                                \end{aligned}
                            \end{aligned}
                    ...
                    \begin{enumerate}
                        ...
                        \begin{enumerate}
                            \item Consider the following:
                                $$
                                    \begin{aligned}
                                        [c_{v_1} \tensor 1 + 1 \tensor c_{v_2}, \sfr_{\g_{[2]}^+}] & = [c_{v_1} \tensor 1 + 1 \tensor c_{v_2}, \sfr_{\g} \1(v_1, v_2) \1^+(t_1, t_2)]
                                    \end{aligned}
                                $$
                            \item Secondly, consider the following:
                                $$[c_{v_1} \tensor 1 + 1 \tensor c_{v_2}, \sfr_{\z_{[2]}^+}]$$
                            \item Thirdly, we have that:
                ...
                \begin{proof}
                    ...
                    From remark \ref{remark: extended_toroidal_lie_bialgebras_explicit_formulae}, we know that:
                        $$
                            ...
                            \end{aligned}
                        $$
                    for any $Y := y v^a t^b$, with $y \in \g$ and $(a, b) \in \Z \x \Z_{\geq 0}$. When $y := h_i$ and $(a, b) = (0, 1)$, the above reduces to:
