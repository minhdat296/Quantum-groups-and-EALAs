                        ...
                        from which one infers that:
                            $$
                                \begin{aligned}
                                    ...
                                    = & -\sum_{r \in \Z \setminus \{0\}} h v_1^{-r} \tensor v_2^r t_2^{-1} \bar{d}(t_2)
                                    \\
                                    = & -(h \tensor \bar{d}(t_2)) \sum_{r \in \Z \setminus \{0\}} v_1^{-r} v_2^r t_2^{-1}
                                \end{aligned}
                            $$
                        ...
                        and then consider the following:
                            $$
                                \begin{aligned}
                                    ...
                                    \\
                                    = & ( \bar{d}(t_1) \tensor h + h \tensor \bar{d}(t_2) ) \sum_{(r, s) \in (\Z \setminus \{0\}) \x \Z_{> 0}} \left( -v_1^r t_1^{s - 1} \tensor v_2^{-r} t_2^{-s} + v_1^{-r} t_1^s \tensor v_2^r t_2^{s - 1} \right)
                                    \\
