                            ...
                            (which is always well-defined since we are in the case $s > 0$), and that:
                                $$
                                    \begin{aligned}
                                        ...
                                        \\
                                        & = \left( \frac{s(a - 1)}{b} + rb  \right) (b - s - 1) Z_{a - r, b - s - 1}
                                    \end{aligned}
                                $$
                            Putting everything together yields:
                                $$[Z_{r, s} \tensor 1 + 1 \tensor Z_{r, s}, \sfr_{\z_{[2]}^+}] = \sum_{(a, b) \in \Z \x \Z_{> 0}} \left( \frac{s(a - 1)}{b} + rb  \right) (b - s - 1) Z_{a, b} \tensor Z_{a - r, b - s - 1} - (r - 1) c_{v_1} \tensor Z_{r, s}$$
                            \item Using the fact that:
                                $$\sfr_{\bar{\d}_{[2]}^+} = \sum_{(a, b) \in \Z \x \Z_{> 0}} D_{a, b} \tensor Z_{a, b} + D_{v_1} \tensor c_{v_2}$$
                            we can infer from the computation of $[Z_{r, s} \tensor 1 + 1 \tensor Z_{r, s}, \sfr_{\z_{[2]}^+}]$ that:
                                $$[Z_{r, s} \tensor 1 + 1 \tensor Z_{r, s}, \sfr_{\bar{\d}_{[2]}^+}] = \sum_{(a, b) \in \Z \x \Z_{> 0}} \left( \frac{s(a - 1)}{b} + rb  \right) (b - s - 1) Z_{a - r, b - s - 1} \tensor Z_{a, b} - (r - 1) Z_{r, s} \tensor c_{v_2}$$
                        \end{enumerate}
