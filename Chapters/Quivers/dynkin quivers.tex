    ...
    \subsection{Quivers}
        ...
        \subsubsection{Dynkin quivers are representation-finite}
            ...
            \end{lemma}
                ...
                \end{proof}
            \begin{proposition}[Indecomposable representations from irreducible representations through coreflections] \label{prop: indecomposable_representations_from_irreducible_representations_through_corelfections}
                Let $\Gamma := (\Gamma_1, \Gamma_0, s, t)$ be a Dynkin quiver with an admissible enumeration of sinks:
                    $$\Gamma_0 := \{\sigma_1 \geq ... \geq \sigma_n\}$$
