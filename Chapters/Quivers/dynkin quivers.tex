\section{Quivers and homological dimensions \texorpdfstring{$\leq 1$}{}}
    \subsection{Quivers}
        ...
        \subsubsection{Dynkin quivers are representation-finite}
            ...
            \end{example}
            \begin{lemma}[Simple relfections are invertible] \label{lemma: simple_reflections_about_roots_are_invertible}
            ...
            Before we actually prove that Dynkin quivers have only finitely many isomorphism classes of indecomposable representations, let us first see how non-irreducible (i.e. non-projective) indecomposable representations can be obtained from irreducible (i.e. projective) ones.
            \begin{lemma}[Coxeter functors are essentially surjective on indecomposable representations] \label{lemma: coxeter_functors_are_essentially_surjective_on_indecomposable_representations}
            ...
            \end{lemma}
                ...
                \end{proof}
            \begin{lemma}[Indecomposable representations from irreducible representations through coreflections] \label{lemma: indecomposable_representations_from_irreducible_representations_through_corelfections}
                Let $\Gamma := (\Gamma_1, \Gamma_0, s, t)$ be a Dynkin quiver with an admissible enumeration of sinks:
                    $$\Gamma_0 := \{\sigma_1 \geq ... \geq \sigma_n\}$$
