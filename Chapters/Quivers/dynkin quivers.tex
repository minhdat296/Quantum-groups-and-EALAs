\section{Quivers, hereditary rings, and homological dimension \texorpdfstring{$\leq 1$}{}}
    \subsection{Quivers}
        ...
        \subsubsection{(Co)reflection functors and Gabriel's Theorem}
            ...
            \end{remark}
            \begin{remark}[Dynkin quivers are unique up to orientations] \label{remark: dynkin_quivers_are_unique_up_to_orientations}
            ...
            \end{remark}
            \begin{proposition}[Compact objects in ind-completions] \label{prop: compact_objects_in_ind_completions}
            ...
            \end{proposition}
                \begin{proof}
                    ...
                    This tells us directly that we indeed have:
                        $$\C \cong \Ind(\C)^{\comp}$$
                \end{proof}
            \begin{corollary}[Finite-length objects are compact] \label{coro: finite_length_objects_are_compact}
            ...
            \end{corollary}
                ...
                \end{proof}
            \begin{corollary}[(Co)reflections of indecomposable representations of Dynkin quivers] \label{coro: (co)reflections_of_indecomposable_representations_of_dynkin_quivers}
            ...
            \begin{convention}[Isomorphism classes of objects]
            ...
            \end{convention}
            \begin{remark}[(Co)reflection functors as adjoints to the constant functor] \label{remark: (co)reflection_functors_as_adjoints_to_the_constant_functor}
                
            \end{remark}
            \begin{lemma}[(Co)reflections of irreducible representations of Dynkin quivers] \label{lemma: (co)reflections_of_irreducible_representations_of_dynkin_quivers_are_self_bijections_on_isomorphism_classes_of_objects}
            ...
            \end{lemma}
                ...
                \end{proof}
            \begin{corollary}[(Co)reflections of indecomposable representations of Dynkin quivers] \label{coro: (co)reflections_of_indecomposable_representations_of_dynkin_quivers_are_self_bijections_on_isomorphism_classes_of_objects}
