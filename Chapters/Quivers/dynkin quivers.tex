    ...
    \subsection{Quivers}
        ...
        \subsubsection{(Co)reflection functors and admissible enumerations of vertices}
            ...
            \end{lemma}
                ...
                \end{proof}
            \begin{theorem}[Coxeter functors preserve non-projective indecomposable representations] \label{theorem: coxeter_functors_preserve_non_projective_indecomposable_representations}
                Let $\Gamma := (\Gamma_1, \Gamma_0, s, t)$ be a connected and acyclic finite quiver with an admissible enumeration of sinks:
                    $$\Gamma_0 := \{\sigma_1 \geq ... \geq \sigma_n\}$$
            ...
            \end{theorem}
                ...
                \end{proof}
            \begin{convention}[Grothendieck group of non-irreducible indecomposable representations of Dynkin quivers]
                ...
                of the same category by:
                    $$\K_0^{\red, \not \irr}(Q)$$
            \end{convention}
            \begin{corollary}[$n^{th}$ Coxeter functors and Grothendieck groups] \label{coro: nth_coxeter_functors_and_grothendieck_groups}
                Let $\Gamma := (\Gamma_1, \Gamma_0, s, t)$ be a connected and acyclic finite quiver with an admissible enumeration of sinks:
                    $$\Gamma_0 := \{\sigma_1 \geq ... \geq \sigma_n\}$$
        ...
        \subsubsection{Dynkin quivers are representation-finite}
            ...
            \end{lemma}    
                \begin{proof}
                    Direct calculations.
                \end{proof}
            \begin{corollary}[Non-irreducible indecomposable representations from irreducible representations through coreflections] \label{coro: non_irreducible_indecomposable_representations_from_irreducible_representations_through_corelfections}
                Let $\Gamma := (\Gamma_1, \Gamma_0, s, t)$ be a Dynkin quiver with an admissible enumeration of sinks:
                    $$\Gamma_0 := \{\sigma_1 \geq ... \geq \sigma_n\}$$
